...
import { ArrowUpRight, ArrowDownRight, AlertCircle, CheckCircle, TrendingUp, Lock, Shield, CreditCard, DollarSign, Info, Clock, Calendar, BarChart2, PieChart as PieChartIcon, ChevronRight } from "lucide-react";
...
const CreditScore = () => {
  ...
  // Función para determinar el nivel del score
  ...
  const scoreInfo = getNivelScore(creditScore);
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <ul className="space-y-2 text-sm">
                          <li className="flex items-start">
                            ...
                            <span>Antigüedad crediticia de más de 5 años</span>
                          </li>
                          <li className="flex items-start">
                            <CheckCircle className="w-4 h-4 mr-2 text-pyme-success flex-shrink-0 mt-0.5" />
                            <span>Diversidad en tipos de crédito</span>
                          </li>
                        </ul>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <ul className="space-y-2 text-sm">
                          <li className="flex items-start">
                            ...
                            <span>Alto porcentaje de utilización de tarjetas</span>
                          </li>
                          <li className="flex items-start">
                            <ArrowDownRight className="w-4 h-4 mr-2 text-pyme-warning flex-shrink-0 mt-0.5" />
                            <span>Retrasos en pagos recientes</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className={`p-4 rounded-lg mb-4 ${scoreInfo.color} text-white`}>
                    ...
                    <p className="text-sm">
                      {scoreInfo.nivel === 'Regular' ? 
                        ...
                        'Descripción correspondiente al nivel'}
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-pyme-gray-dark">Probablemente calificarás para la mayoría de los créditos, pero con tasas de interés promedio.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-pyme-gray-dark">Con hábitos financieros saludables, podrías mejorar tu score en 3-6 meses.</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <CardContent>
                ...
                <div className="mt-6 bg-gray-50 p-4 rounded-lg">
                  <div className="flex justify-between mb-3">
                    ...
                    <span className="font-medium">$51,500 MXN</span>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        <span>Créditos Automotrices</span>
                        <span>$35,000 (68%)</span>
                      </div>
